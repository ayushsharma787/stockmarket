    ...
    with tab4:
        ...
        if pair_t1 in ret_df.columns and pair_t2 in ret_df.columns and pair_t1 != pair_t2:
            ...
            fig4.add_vrect(x0="2022-01-01", x1="2022-12-31",
                            fillcolor="rgba(248,81,73,0.07)", line_width=0, annotation_text="2022 Bear")
            fig4.add_vrect(x0="2023-01-01", x1="2023-12-31",
                            fillcolor="rgba(63,185,80,0.05)", line_width=0, annotation_text="2023 AI Bull")
...
# ═══════════════════════════════════════════════════════════════════════════
    ...
    fig.add_vrect(x0="2022-01-01",x1="2022-12-31",fillcolor="rgba(248,81,73,0.07)",
                  line_width=0,annotation_text="2022 Bear",row=1,col=1)
...
# ═══════════════════════════════════════════════════════════════════════════
    ...
    fig_sh.add_hline(y=1, line_dash="dot", line_color="#3fb950", annotation_text="Sharpe=1")
    ...
    if spy is not None:
        ...
        for i, t in enumerate([x for x in selected_multi if x in frames]):
            ...
            fig_b.add_trace(go.Scatter(x=beta_roll.index, y=beta_roll, name=t,
                                        mode="lines", line=dict(width=1.5, color=META_INFO[t]["color"])))
        fig_b.add_hline(y=1, line_dash="dash", line_color="#64748b", annotation_text="β=1 (market)")
    ...
    fig_ac.add_hline(y=ci_bound,  line_dash="dash", line_color="#f6ad55", annotation_text="+95% CI")
    fig_ac.add_hline(y=-ci_bound, line_dash="dash", line_color="#f6ad55", annotation_text="–95% CI")
    ...
    fig_vc.add_vrect(x0="2022-01-01", x1="2022-12-31",
                      fillcolor="rgba(248,81,73,0.08)", line_width=0, annotation_text="2022 High-Vol Regime")
...
# ═══════════════════════════════════════════════════════════════════════════
    ...
    with tabs[2]:
        ...
        fig_ol.add_hline(y=float(sig3_), line_dash="dash", line_color="#f6ad55",
                          annotation_text=f"+3σ ({sig3_:.2f}%)")
        fig_ol.add_hline(y=-float(sig3_), line_dash="dash", line_color="#f6ad55",
                          annotation_text=f"-3σ (−{sig3_:.2f}%)")
        fig_ol.add_hline(y=0, line_color="#334155", line_dash="dot")
        fig_ol.add_vrect(x0="2022-01-01",x1="2022-12-31",
                          fillcolor="rgba(248,81,73,0.06)",line_width=0,annotation_text="2022 Bear")
