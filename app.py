...
@st.cache_data(show_spinner=False)
def train_all(_ind):
    return {t: train_lstm(t, _ind) for t in TICKERS}
...
# ═══════════════════════════════════════════════════════════════════════════
    ...
    ta_t = st.selectbox("Select Stock", TICKERS, key="ta_t")
    ind  = ind_data[ta_t]
...
# ═══════════════════════════════════════════════════════════════════════════
    ...
    mtf_t = st.selectbox("Select Stock", TICKERS, key="mtf_t")
    ...
    with tab_sr:
        ...
        sr_t    = st.selectbox("Stock", TICKERS, key="sr_t")
...
# ═══════════════════════════════════════════════════════════════════════════
    ...
    with c1:
        ...
        avg_c = pd.Series({t: ret_df[[o for o in TICKERS if o != t]].corrwith(ret_df[t]).mean()
                           for t in TICKERS}).sort_values(ascending=False)
