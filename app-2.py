...
# ═══════════════════════════════════════════════════════════════════════════
    ...
    df_d  = frames_long.get(mtf_t) if mtf_t in frames_long else frames.get(mtf_t)
    ...
    with tab_yr:
        ...
        for t in LOADED_TICKERS:
            dfl = frames_long.get(t) if t in frames_long else frames.get(t)
...
# ═══════════════════════════════════════════════════════════════════════════
    ...
    dfl_dd = frames_long.get(dd_t) if dd_t in frames_long else frames.get(dd_t)
