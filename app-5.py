...
# ═══════════════════════════════════════════════════════════════════════════
    ...
    # df_d computed inside tabs that need it — avoids top-level DataFrame bool crash
    ...
    with tab_cal:
        ...
        _fl_cal = frames_long if len(frames_long) > 0 else frames
        df_d = _fl_cal.get(mtf_t) if mtf_t in _fl_cal else frames.get(mtf_t)
    ...
    with tab_yr:
        ...
        for t in LOADED_TICKERS:
            _fl2 = frames_long if len(frames_long) > 0 else frames
            dfl = _fl2.get(t) if t in _fl2 else frames.get(t)
...
# ═══════════════════════════════════════════════════════════════════════════
    ...
    _fl3 = frames_long if len(frames_long) > 0 else frames
    dfl_dd = _fl3.get(dd_t) if dd_t in _fl3 else frames.get(dd_t)
